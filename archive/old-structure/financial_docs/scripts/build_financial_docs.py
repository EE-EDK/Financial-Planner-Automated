...
CATEGORIZATION_RULES = {
    ...
    'Analysis & Insights': {
        'patterns': ['SPENDING_ANALYSIS', 'PROPERTY_308', 'ANALYSIS', 'TRANSACTION_ANALYSIS', 'SCENARIO_ANALYSIS', 'FINANCIAL_TRENDS'],
        'icon': '📈',
...
BADGE_RULES = {
    ...
    'analysis': ['SPENDING_ANALYSIS', 'PROPERTY_308'],
    'tax': ['W2', '1099', '1098', 'Tax Return'],
    'large': ['AllTransactions', 'SPENDING_ANALYSIS', 'PROPERTY_308']
}
...
def make_friendly_name(filename):
    ...
    replacements = {
        ...
        'PROPERTY_308_RENTAL_ANALYSIS': '308 Jamie Ct - Rental Property Analysis',
        'BUDGET_GUIDELINES': 'Budget Guidelines & Rocket Money Settings',
        'W2_Ethan_Honeywell': 'W2 - Ethan (Honeywell)',
        'W2_Kenia_DiagnosticImaging': 'W2 - Kenia (Diagnostic Imaging)',
        'AllTransactions': 'All Transactions (CSV)',
        '1099_Fidelity_401k_Ethan': '1099 - Fidelity 401k (Ethan)',
        '1099R_TSP_Ethan_Cashout': '1099-R - TSP Cashout (Ethan)',
        '1098_808_Home_Mortgage': '1098 - 808 Home Mortgage',
        '1098_308_RentalIncome': '1098 - 308 Rental Income',
        'Current-Budget-RocketMoney': 'Current Budget (Rocket Money Screenshot)',
        'Money-as-of-June-2025-snapshot': 'Money Snapshot (June 2025)'
    }
...
def build_docs_structure_from_archive():
    ...
    for filepath in files:
        ...
        # Get relative path from BASE_DIR (e.g., "Archive/tax/W2_Ethan.pdf")
...
<html lang="en">
<!--
    Kunz Family Financial Hub - Auto-Generated Financial Document Viewer
...
<head>
    ...
    <title>Kunz Family Financial Hub</title>
...
<body>
    <div class="container">
        <header>
            <h1>💰 Kunz Family Financial Hub</h1>
...
def main():
    print("💰 Kunz Family Financial Documentation Builder")
    print("=" * 70)
    print()
