...
def calculate_credit_card_payoff(config):
    ...
    # Example payment amounts to model
    ...
    # Estimate current minimum payment (example: 2% of balance or $25, whichever is higher)
    current_monthly = max(25, total_cc_debt * 0.02) if total_cc_debt > 0 else 0
